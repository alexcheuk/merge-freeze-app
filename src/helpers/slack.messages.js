...
export const generateMergeFreezeReply = ({
  user_id,
  user_name,
  text,
  repos,
...
export const generateMergeUnfreezeReply = ({
  user_id,
  user_name,
  text,
  repos,
...
export const generateMergeUnfreezePRReply = ({
  user_id,
  owner,
  repo,
  prId,
